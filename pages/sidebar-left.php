	...
	<aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                            ...
                            <li>
                                <a href="../covid-tracking/individual-list.php">
                                    <i class="fa fa-users"></i> <span>Individual List</span>
                                </a>
                            </li>
                            <li>
                                <a href="../covid-tracking/establishment-list.php">
                                    <i class="fa fa-building"></i> <span>Establishment List</span>
                                </a>
                            </li>
                            <li>
                                <a href="../covid-tracking/province-list.php">
                                    <i class="fa fa-building"></i> <span>State/Province List</span>
                                </a>
                            </li>
                            <li>
                                <a href="../covid-tracking/city-list.php">
                                    <i class="fa fa-building"></i> <span>State/City List</span>
                                </a>
                            </li>
                            <li>
                                <a href="../covid-tracking/barangay-list.php">
                                    <i class="fa fa-building"></i> <span>Barangay/Zone List</span>
                                </a>
                            </li>
                            <li>
                                <a href="../covid-tracking/cts-reports.php">
                                    <i class="fa fa-building"></i> <span>CTS Reports</span>
                                </a>
                            </li>
                    </ul>';
                    }
